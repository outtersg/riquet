...
require_once dirname(__FILE__).'/../vendor/gui/majeur/Majeur.php';
require_once dirname(__FILE__).'/../vendor/gui/majeur/MajeurSiloPdo.php';
require_once dirname(__FILE__).'/../vendor/gui/majeur/MajeurListeurDossiers.php';
require_once dirname(__FILE__).'/../vendor/gui/majeur/MajeurJoueurPdo.php';
